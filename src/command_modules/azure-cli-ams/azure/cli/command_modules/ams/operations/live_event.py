...
def create(client, resource_group_name, account_name, live_event_name, streaming_protocol, location,
    ...
    ip_access_control = IPAccessControl(allow=allow_list)
    live_event_preview_access_control = LiveEventPreviewAccessControl(ip=ip_access_control)
    ...
    live_event_preview = LiveEventPreview(preview_locator=preview_locator, streaming_policy_name=streaming_policy_name,
