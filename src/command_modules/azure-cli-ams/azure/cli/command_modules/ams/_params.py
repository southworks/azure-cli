...
def load_arguments(self, _):  # pylint: disable=too-many-locals, too-many-statements
    ...
    with self.argument_context('ams streaming policy') as c:
        ...
        c.argument('envelope_label', arg_group='Envelope Encryption', help='Label used to specify Content Key when creating a streaming locator.')
        c.argument('envelope_policy_name', arg_group='Envelope Encryption', help='Policy used by Default Key.')
