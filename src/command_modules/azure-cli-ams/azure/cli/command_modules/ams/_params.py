...
def load_arguments(self, _):  # pylint: disable=too-many-locals, too-many-statements
    ...
    with self.argument_context('ams transform') as c:
        ...
        c.argument('preset', help='Preset that describes the operations that will be used to modify, transcode, or extract insights from the source file to generate the transform output. Allowed values: {}. In addition to the allowed values, you can also pass a path to a custom preset JSON file.'
    ...
    with self.argument_context('ams streaming policy') as c:
        ...
        c.argument('envelope_clear_tracks', arg_group='Envelope Encryption', help='The filepath to a JSON representing which tracks should not be encrypted. Use @{file} to load from a file.')
        c.argument('envelope_key_to_track_mappings', arg_group='Envelope Encryption', help='The filepath to a JSON representing a list of StreamingPolicyContentKey. Use @{file} to load from a file.')
        ...
        c.argument('cenc_clear_tracks', arg_group='Common Encryption CENC', help='The filepath to a JSON representing which tracks should not be encrypted. Use @{file} to load from a file.')
        c.argument('cenc_key_to_track_mappings', arg_group='Common Encryption CENC', help='The filepath to a JSON representing a list of StreamingPolicyContentKey. Use @{file} to load from a file.')
