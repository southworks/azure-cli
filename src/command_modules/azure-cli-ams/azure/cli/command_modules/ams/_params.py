...
def load_arguments(self, _):  # pylint: disable=too-many-locals, too-many-statements
    ...
    ip_range_type = CLIArgumentType(nargs='+', help='Space-separated IP addresses for access control. You can also use CIDR notation to specify the length of the subnet mask prefix (e.g: 192.168.0.0/28). Use "" to clear existing list. Default is 0.0.0.0/0.')
